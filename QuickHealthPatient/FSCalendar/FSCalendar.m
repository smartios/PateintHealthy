...
//    }
    ...
    imageView.image =   [UIImage imageNamed:@"calenderSelection"];
    cell.image = [UIImage imageNamed:@"calenderSelection"];
    
    for (int i = 0; i < _BookedDates.count; i++)
    {
        
        NSString *dateFromServer = [self getDateStringFromDateString:[[_BookedDates objectAtIndex:i] valueForKey:@"available_date"] fromDateString:@"dd-MMM-yyy" toDateString:@"yyyy-MM-dd"];
...
//       if(self.allowMultipleSelect == NO)
//        {
//            imageView.image =   [UIImage imageNamed:@"markerBlue"];
//            cell.image = [UIImage imageNamed:@"markerBlue"];
//        }else
//        {
            imageView.image =   [UIImage imageNamed:@"calenderSelection"];
            cell.image = [UIImage imageNamed:@"calenderSelection"];
