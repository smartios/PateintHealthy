 ...
 */
@property (nullable, assign, nonatomic) NSDate *selectedDate;

/**
 The dates representing the selected dates. (read-only)
 */
@property ( assign,nonatomic) NSArray<NSDate *> *selectedDates;

@property ( assign,nonatomic) NSMutableArray *BookedDates;
@property ( assign,nonatomic) BOOL allowMultipleSelect;
